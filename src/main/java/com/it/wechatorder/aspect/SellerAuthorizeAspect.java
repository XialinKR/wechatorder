package com.it.wechatorder.aspect;
...
public class SellerAuthorizeAspect {
    ...
    @Pointcut("execution(public * com.it.wechatorder.controller.Seller*.*(..))" +
    "&& !execution(public * com.it.wechatorder.controller.SellerLoginController.*(..))")
    public void verify() {}
